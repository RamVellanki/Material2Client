System.register(['angular2/testing', 'angular2/core', 'angular2/platform/browser', './progress_circle'], function(exports_1) {
    ...
    var testing_1, core_1, browser_1, progress_circle_1;
    var TestApp;
    function main() {
        describe('MdProgressCircular', function () {
            ...
            testing_1.it('should apply a mode of "determinate" if an invalid mode is provided.', function (done) {
                builder
    ...
    function getChildDebugElement(parent, selector) {
        return parent.query(browser_1.By.css(selector));
    }
    return {
        setters:[
...
//# sourceMappingURL=../../../../components/progress-circle/progress_circle.spec.js.map